...
5. Implement the InsertAtPos() function to insert a node at a specified position.
6. Implement the DeleteFirst() function to delete the first node of the linked list.
7. Implement the Display() function to display all the nodes of the linked list.
8. Implement the Count() function to count and return the total number of nodes.
9. In the main() function, create an empty linked list, perform insertion and deletion operations, display the linked list, and print the total number of nodes.
...
Algorithm:- 1. Start the program.
            ...
            11. Display the updated linked list.
            12. Count and display the updated number of nodes.
            13. Stop the program.
*/
